...
function renderTechnicianPortal(){
  ...
  const priorityRezolvat=c=>{
    if(!c.notStarted||c.stage==='trimis')return 99;
    const pd=!c.noProba?parseShortDate(c.probaDate):null;
    const fd=parseShortDate(c.finala);
