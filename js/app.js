...
function buildSidebarHTML(role,user){
  ...
  return`<div class="brand"><div class="brand-mark"><img class="brand-logo" src="assets/private-cad-logo.png" alt="PC LAB"></div><div class="brand-name">PC LAB</div></div>
...
function renderTechnicianPortal(){
  ...
  const myActive=[...myInProgress,...approvedCases,...waitingBars];
  ...
  document.querySelectorAll('.tp-task-btn[data-action]').forEach(btn=>{
    btn.addEventListener('click',e=>{
      ...
      else if(act==='bars-done'){c.stageStatuses[sid]='proba_aprobata'}
...
function renderLogin(){
  ...
  if(sb){
    ...
    root.innerHTML=`<div class="login-shell"><div class="login-box"><div class="login-brand"><div class="login-brand-mark"><img class="brand-logo" src="assets/private-cad-logo.png" alt="PC LAB"></div><div class="login-brand-name">PC LAB</div></div>
...
<button class="btn" id="showLogin" style="width:100%;font-size:12px">← Înapoi la autentificare</button></div>
    ...
    root.innerHTML=`<div class="login-shell"><div class="login-box"><div class="login-brand"><div class="login-brand-mark"><img class="brand-logo" src="assets/private-cad-logo.png" alt="PC LAB"></div><div class="login-brand-name">PC LAB</div></div><div class="login-err" style="display:block">Sistemul necesită conexiune Supabase. Contactați administratorul.</div></div></div>`;
  }
}
