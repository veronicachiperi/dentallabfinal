...
function renderCaseDetail(){
  ...
  const actionsMenu=isClinicView
    ?`<button type="button" data-case-action="view-pdf">Fișă PDF — Vizualizează</button><button type="button" data-case-action="pdf">Fișă PDF — Descarcă</button><button type="button" data-case-action="archive">Arhivează</button><button type="button" data-case-action="delete" class="danger">Șterge lucrarea</button>`
